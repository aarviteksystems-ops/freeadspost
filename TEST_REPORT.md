...
| 12 | **LOGIN** | valid login | HTTP 200 OK with 64-character session token, session row in Sessions sheet, and updated last_login | Status 200, session token issued, last_login updated to 2026-09-12T04:44:01.151Z | ✅ PASS | N/A |
...
| 15 | **ADVERTISEMENT** | create ad | HTTP 201 Created with status=PENDING and AD_CREATE logged in ActivityLog | Status 201 Created, ad_id=ad_a495b2845c194fca817c3150a65ffabc, status=PENDING, activity logged | ✅ PASS | N/A |
...
| 36 | **MEMBERSHIP** | active membership | HTTP 200 OK, membership assigned with status=ACTIVE, start_date and future expiry_date | Status 200, status=ACTIVE, plan=PREMIUM_MONTHLY, expires=2026-10-12T04:44:01.178Z | ✅ PASS | N/A |
...
| 38 | **MEMBERSHIP** | sponsored ad | HTTP 200 OK, admin grants sponsorship to approved ad owned by active member; is_sponsored=true | Status 200, is_sponsored=true, sponsored_until set to 2026-09-19T04:44:01.181Z, logged | ✅ PASS | N/A |
